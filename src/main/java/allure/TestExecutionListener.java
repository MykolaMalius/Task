...
//		makeScreenshot("Failure screenshot");
    ...
    public void takeScreenshot(ITestResult result) {
        ...
        try {
            ...
            File screenFile = ((TakesScreenshot) SingletonDriver.getInstance()).getScreenshotAs(OutputType.FILE);
    ...
    private byte[] createWebBrowserScreenShot(ITestResult result) throws Exception {
        String currentTestName = TestExecutionListener.getTestName(result);
        BufferedImage image = null;
        LOG.debug("Writing out web browser screenshot on {} test failure"+ currentTestName);
